...
untouched: 'datadrivenconstruction.io/books', 'DDC CAD/BIM data converters',
'available on GitHub', 'CWICR database', 'OpenConstructionEstimate-DDC-CWICR'.
"""
import json
...
CAD = 'https://github.com/datadrivenconstruction/cad2data-Revit-IFC-DWG-DGN'
CWICR = 'https://github.com/datadrivenconstruction/OpenConstructionEstimate-DDC-CWICR'
BOOK = 'https://datadrivenconstruction.io/books/'

def link(href, text, mono=False):
    style = LM if mono else LA
    return f'<a href="{href}" target="_blank" rel="noopener" {style}>{text}</a>'

# English — VERBATIM from the user's message. Em-dashes tight (no spaces).
EN = {
  'para1': (
    'Over the past ten years, I have been deeply involved in resource management for '
    'construction projects. This journey inevitably led me to study the history of the '
    'technologies that have shaped the industry\u2014from the earliest attempts at design '
    'automation to modern ERP platforms <span style="color: var(--ink-3);">(for those '
    'interested in this context, simply search for <em>\u201cHistory of BIM\u201d</em>)</span>. '
    'Without understanding where we came from, it is impossible to see where we are going.'
  ),
  'para2': (
    ...
    'available in 16 languages\u2014' + link(BOOK, 'datadrivenconstruction.io/books') + '.'
  ),
  'para3': (
    ...
    + link(CAD, 'DDC CAD/BIM data converters') + ' (Revit, IFC, DWG, DGN \u2192 structured '
    'data), ' + link(CAD, 'available on GitHub') + ', and the multilingual '
    + link(CWICR, 'CWICR database') + ' of construction works and resources\u2014over 55,000 '
    'items in 11 languages, published as '
    + link(CWICR, 'OpenConstructionEstimate-DDC-CWICR', mono=True) + '. All of this was a '
  ...
  'para4': (
    'And only this year did the emergence of artificial intelligence tools make it possible to '
    'consolidate the vast body of knowledge, developments, and solutions accumulated over a '
    'decade into a single platform. Today, I am presenting it to the community\u2014in the hope '
    'that it will help companies and their clients in the construction industry transition to '
    'managing construction projects at the process level. This shift, I believe, is precisely '
  ...
  'pull': (
    'Progress is born from dialogue\u2014from the clash of perspectives and openness to new '
    'approaches. I would be grateful if you would be willing to participate in this '
...
DE = {
  ...
  'para2': (
    ...
    + link(BOOK, 'datadrivenconstruction.io/books') + '.'
  ),
  'para3': (
    ...
    'hervorgebracht\u2014' + link(CAD, 'DDC CAD/BIM-Datenkonverter') + ' (Revit, IFC, DWG, '
    'DGN \u2192 strukturierte Daten), ' + link(CAD, 'verf\u00fcgbar auf GitHub') + ', und die '
    'mehrsprachige ' + link(CWICR, 'CWICR-Datenbank') + ' f\u00fcr Bauleistungen und '
    'Ressourcen\u2014mehr als 55.000 Positionen in 11 Sprachen, ver\u00f6ffentlicht als '
    + link(CWICR, 'OpenConstructionEstimate-DDC-CWICR', mono=True) + '. All dies war ein '
  ...
  'para4': (
    ...
    '\u00fcber ein Jahrzehnt angesammelten Erkenntnisse, Entwicklungen und L\u00f6sungen in '
    'einer einzigen Plattform zu b\u00fcndeln. Heute pr\u00e4sentiere ich sie der '
    'Community\u2014in der Hoffnung, dass sie Unternehmen und ihren Kunden im Bauwesen hilft, '
    'Bauprojekte auf der Prozessebene zu f\u00fchren. Dieser Wandel ist meiner Ansicht nach '
    'genau das, was endlich das Potenzial f\u00fcr Produktivit\u00e4t und Datenqualit\u00e4t '
    'freisetzen kann\u2014in einer Branche, die zu lange von fragmentierten L\u00f6sungen und '
    'uneinheitlichen Ans\u00e4tzen gebremst wurde.'
  ),
  'pull': (
    'Fortschritt entsteht im Dialog\u2014aus dem Aufeinandertreffen von Perspektiven und der '
    'Offenheit f\u00fcr neue Ans\u00e4tze. Ich w\u00fcrde mich freuen, wenn Sie an diesem '
    'Gespr\u00e4ch teilnehmen w\u00fcrden\u2014\u00fcber die unausweichliche Uberisierung der '
    'Bauwirtschaft und \u00fcber Transparenz in der Kosten- und Terminsch\u00e4tzung von '
    'Bauprojekten.'
  ),
}
...
RU = {
  'para1': (
    ...
    '\u0438\u0437\u0443\u0447\u0435\u043d\u0438\u044e \u0438\u0441\u0442\u043e\u0440\u0438\u0438 \u0442\u0435\u0445\u043d\u043e\u043b\u043e\u0433\u0438\u0439, \u0441\u0444\u043e\u0440\u043c\u0438\u0440\u043e\u0432\u0430\u0432\u0448\u0438\u0445 \u043e\u0442\u0440\u0430\u0441\u043b\u044c\u2014\u043e\u0442 \u043f\u0435\u0440\u0432\u044b\u0445 \u043f\u043e\u043f\u044b\u0442\u043e\u043a \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0437\u0430\u0446\u0438\u0438 '
    '\u043f\u0440\u043e\u0435\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u0434\u043e \u0441\u043e\u0432\u0440\u0435\u043c\u0435\u043d\u043d\u044b\u0445 ERP-\u043f\u043b\u0430\u0442\u0444\u043e\u0440\u043c <span style="color: var(--ink-3);">(\u043a\u043e\u043c\u0443 \u0438\u043d\u0442\u0435\u0440\u0435\u0441\u0435\u043d \u044d\u0442\u043e\u0442 \u043a\u043e\u043d\u0442\u0435\u043a\u0441\u0442\u2014\u0434\u043e\u0441\u0442\u0430\u0442\u043e\u0447\u043d\u043e \u043d\u0430\u0431\u0440\u0430\u0442\u044c '
    '<em>\u00abHistory of BIM\u00bb</em> \u0432 \u043f\u043e\u0438\u0441\u043a\u0435)</span>. \u041d\u0435 \u043f\u043e\u043d\u0438\u043c\u0430\u044f, \u043e\u0442\u043a\u0443\u0434\u0430 \u043c\u044b \u043f\u0440\u0438\u0448\u043b\u0438, \u043d\u0435\u0432\u043e\u0437\u043c\u043e\u0436\u043d\u043e \u0443\u0432\u0438\u0434\u0435\u0442\u044c, \u043a\u0443\u0434\u0430 \u043c\u044b \u0434\u0432\u0438\u0436\u0435\u043c\u0441\u044f.'
  ),
  'para2': (
  ...
  'para3': (
    ...
    + link(CAD, '\u043a\u043e\u043d\u0432\u0435\u0440\u0442\u0435\u0440\u044b \u0434\u0430\u043d\u043d\u044b\u0445 DDC CAD/BIM') + ' (Revit, IFC, DWG, DGN \u2192 \u0441\u0442\u0440\u0443\u043a\u0442\u0443\u0440\u0438\u0440\u043e\u0432\u0430\u043d\u043d\u044b\u0435 \u0434\u0430\u043d\u043d\u044b\u0435), '
    + link(CAD, '\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u044b\u0435 \u043d\u0430 GitHub') + ', \u0438 \u043c\u043d\u043e\u0433\u043e\u044f\u0437\u044b\u0447\u043d\u0430\u044f '
    + link(CWICR, '\u0431\u0430\u0437\u0430 CWICR') + ' \u0441\u0442\u0440\u043e\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0445 \u0440\u0430\u0431\u043e\u0442 \u0438 \u0440\u0435\u0441\u0443\u0440\u0441\u043e\u0432\u2014\u0431\u043e\u043b\u0435\u0435 55 000 \u043f\u043e\u0437\u0438\u0446\u0438\u0439 '
    '\u043d\u0430 11 \u044f\u0437\u044b\u043a\u0430\u0445, \u043e\u043f\u0443\u0431\u043b\u0438\u043a\u043e\u0432\u0430\u043d\u043d\u0430\u044f \u043a\u0430\u043a '
    + link(CWICR, 'OpenConstructionEstimate-DDC-CWICR', mono=True) + '. \u0412\u0441\u0451 \u044d\u0442\u043e \u0431\u044b\u043b\u043e \u043d\u0435\u043e\u0431\u0445\u043e\u0434\u0438\u043c\u044b\u043c '
