...
Scaffolding mirrors ``test_reporting_currency.py``. The SQLAlchemy engine is
bound to the conftest-provisioned PostgreSQL cluster before this module is
imported, so these tests run against PostgreSQL.
"""
