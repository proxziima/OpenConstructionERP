...
def upgrade() -> None:
    ...
    if not _has_table(inspector, _TABLE):
        op.create_table(
            ...
            sa.Column("bge_rerank_used", sa.Boolean(), nullable=False, server_default=sa.text("false")),
            sa.Column("llm_rerank_used", sa.Boolean(), nullable=False, server_default=sa.text("false")),
